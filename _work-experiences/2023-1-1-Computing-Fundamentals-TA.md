...
description: |
  <ul>
    <li>Held office hours to assist students with Python programming syntax, libraries, and core topics such as data structures & algorithms (DSA), object-oriented programming (OOP), NumPy, and unit testing.</li>
